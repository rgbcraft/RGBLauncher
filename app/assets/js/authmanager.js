...
const {RestResponseStatus} = require('rgblauncher-core/common')
const {MojangRestAPI, mojangErrorDisplayable, MojangErrorCode} = require('rgblauncher-core/mojang')
const {MicrosoftAuth, microsoftErrorDisplayable, MicrosoftErrorCode} = require('rgblauncher-core/microsoft')
...
async function validateSelectedMojangAccount() {
    ...
    if (current.uuid == null || current.uuid === '') {
        return true
    }
